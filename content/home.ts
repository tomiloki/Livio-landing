export const homeContent = {
  ...
  scope: {
    ...
    footer: "Estamos en fase piloto. Las primeras empresas tienen implementación gratuita, 50% de descuento durante 12 meses y acceso directo al equipo. Los cupos son limitados.",
  },
  ...
  about: {
    ...
    team: [
      ...
      },
      {
        name: "Esteban Cortés",
        role: "Socio Técnico",
        bio: "Transformó la idea en un producto técnicamente viable. Lidera la arquitectura de software y todas las decisiones técnicas del producto.",
        initials: "EC",
        isFounder: false,
        photo: null,
      },
      {
        ...
        role: "Socio Logístico",
        bio: "Conocimiento real del rubro: procesos operativos, lógica del servicio, validación con clientes. Conecta el producto con la realidad del día a día.",
        initials: "IS",
        isFounder: false,
        photo: null,
      },
  ...
  finalCTA: {
    ...
    benefits: [
      "Implementación gratuita",
      "50% de descuento durante 12 meses",
      "Onboarding acompañado por el equipo",
      "Acceso directo para dar feedback y moldear el producto",
    ],
    cta: {
      primary: { label: "Quiero ser empresa piloto", href: "/#contacto" },
